...
> Go to https://cards-against-developers.github.io/game/ to play with friends
> (or ["singleplayer mode"](https://cards-against-developers.github.io/game/dev/singleplayer/))
